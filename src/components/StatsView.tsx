 ...
 * - カード: bg-gray-50/80 rounded-2xl p-4
  ...
  return (
    <div className="h-full overflow-y-auto no-scrollbar px-4 py-4 space-y-4">
      ...
      <div className="flex gap-3">
        {/* 平均実質カロリー */}
        {days > 0 && (
          <div className="bg-gray-50/80 rounded-2xl p-4 w-[130px] shrink-0">
        ...
        {data.goal && calendarDays.length > 0 && (
          <div className="bg-gray-50/80 rounded-2xl p-3 flex-1 min-w-0">
