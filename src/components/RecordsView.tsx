...
function SwipeableCard({ children, onDelete }: { children: React.ReactNode; onDelete: () => void }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl">
      ...
      <div
        ref={cardRef}
        className="relative bg-white rounded-2xl p-4 border border-gray-200 shadow-md active:bg-gray-50 transition-colors duration-150"
...
function SwipeDownModal({ onClose, children }: { onClose: () => void; children: React.ReactNode }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col justify-end bg-black/30" onClick={onClose}>
      <div
        ref={sheetRef}
        className="bg-white rounded-t-3xl p-5 pb-[max(env(safe-area-inset-bottom,28px),28px)] w-full animate-slideUp"
