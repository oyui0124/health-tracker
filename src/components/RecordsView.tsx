...
function SwipeableCard({ children, onDelete }: { children: React.ReactNode; onDelete: () => void }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl">
      ...
      <div
        ref={cardRef}
        className="relative bg-white rounded-2xl p-4 border border-gray-200/80 shadow-[0_1px_3px_rgba(0,0,0,0.08),0_4px_12px_rgba(0,0,0,0.04)] active:bg-gray-50 transition-colors duration-150"
