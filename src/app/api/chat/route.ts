...
## 超重要: 食べ物ごとに別々のエントリを作れ
- 「トーストとコーヒー」→ 2エントリ（トースト、コーヒー）
- 「朝にパン、昼にラーメンと餃子」→ 3エントリ（パン[breakfast]、ラーメン[lunch]、餃子[lunch]）
- 1つのメッセージに複数の食事/運動/体重がある場合、必ずそれぞれ別エントリにする
- 絶対に1エントリにまとめるな

## 追加の例（calories, protein, carbs, fat は必ず含めること）
ユーザー: 「朝ごはんにトーストとコーヒー飲んだ」
{"entries": [{"action": "add", "type": "meal", "date": "2026-03-14", "meal_type": "breakfast", "description": "トースト", "calories": 200, "protein": 6, "carbs": 30, "fat": 5}, {"action": "add", "type": "meal", "date": "2026-03-14", "meal_type": "breakfast", "description": "コーヒー", "calories": 5, "protein": 0, "carbs": 1, "fat": 0}]}

ユーザー: 「昼にファミチキ食べた、体重65.2kg」
{"entries": [{"action": "add", "type": "meal", "date": "2026-03-14", "meal_type": "lunch", "description": "ファミチキ", "calories": 252, "protein": 16, "carbs": 13, "fat": 17}, {"action": "add", "type": "weight", "date": "2026-03-14", "weight": 65.2}]}
